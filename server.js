...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: { 
        user: 'sheikhtaj466@gmail.com', // Yahan aapka asli email hona chahiye
        pass: 'eluplxqapjdtwpsh'     // Yahan aapka asli 16-digit App Password hona chahiye
    }
});
...
app.post('/send-otp', (req, res) => {
    ...
    transporter.sendMail(mailOptions, (error, info) => {
        if (error) {
            // --- YEH HAI NAYA, DETAILED ERROR LOGGING ---
            console.error("--- NODEMAILER ERROR START ---");
            console.error(JSON.stringify(error, null, 2)); // Poora error object print karega
